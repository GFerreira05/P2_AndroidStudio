...
class ListaDeAtividades : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_lista_de_atividades)

        val botaoEntregaPagina: Button = findViewById(R.id.btnEntrega1)
        botaoEntregaPagina. setOnClickListener{
            var intent = Intent(this,EntregaDeAtividade()::class.java)
            startActivity(intent)
        }

        val botaoCadastroPagina: Button = findViewById(R.id.btnMais)
        botaoCadastroPagina. setOnClickListener{
            var intent = Intent(this,CadastroDeAtividade()::class.java)
            startActivity(intent)
        }
