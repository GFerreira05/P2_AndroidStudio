...
class EntregaDeAtividade : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_entrega_de_atividade)

        val botaoEntregar: Button = findViewById(R.id.btn_Entregar)
        botaoEntregar. setOnClickListener {
            AlertDialog.Builder(this)
                .setTitle("Entrega Recebida")
                .setMessage("Aguarde a confirmação do Professor")
                .setPositiveButton("OK") { variavel, numeroOpcao -> }
                .create()
                .show()
        }
